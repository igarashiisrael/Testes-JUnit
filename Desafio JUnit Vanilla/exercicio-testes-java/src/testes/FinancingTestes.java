...
public class FinancingTestes {
    ...
    @Test
    public void setTIncomeShouldThrowIllegalArgumentExceptionWhenInvalidData() {
    ...
    @Test
    public void setTMonthsShouldThrowIllegalArgumentExceptionWhenInvalidData() {
